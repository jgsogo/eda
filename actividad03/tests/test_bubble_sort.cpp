...
TEST_CASE( "bubble_sort - Empty vector", "[test_bubble_sort.cpp]" )
{
...
TEST_CASE( "bubble_sort - Vectors with one element", "[test_bubble_sort.cpp]" )
{
...
TEST_CASE( "bubble_sort - Vectors with two elements", "[test_bubble_sort.cpp]" )
{
...
TEST_CASE( "bubble_sort - Vectors with three elements", "[test_bubble_sort.cpp]" )
{
...
SCENARIO( "bubble_sort - Vectors with more elements", "[test_bubble_sort.cpp]" )
{
